...
using Dfe.CaseAggregationService.Api.Swagger;
...
namespace Dfe.CaseAggregationService.Api
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddHttpClient("AcademisationApiClient", (sp, client) =>
            {
                ApiUsingKeyOptions apiOptions = builder.Configuration.GetRequiredSection("AcademisationApiClient").Get<ApiUsingKeyOptions>();
            ...
            builder.Services.AddHttpClient("MfspApiClient", (sp, client) =>
            {
                ApiUsingKeyOptions apiOptions = builder.Configuration.GetRequiredSection("MfspApiClient").Get<ApiUsingKeyOptions>();
