...
using ValidationException = Dfe.CaseAggregationService.Application.Common.Exceptions.ValidationException;

namespace Dfe.CaseAggregationService.Api.Middleware;
